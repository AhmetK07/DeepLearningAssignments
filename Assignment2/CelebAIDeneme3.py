...
content_image_path = '/home/kaan/Elif Hoca Assignments/AubreyPlaza.jpg'
style_image_path = '/home/kaan/Elif Hoca Assignments/brick.jpg'
...
def train(content_image, style_image, epochs=1500, display_interval=5, save_directory='generated_images'):
    ...
    for epoch in range(epochs):
        total_loss = train_step(generated_image, content_image, style_images)

        if epoch % display_interval == 0:
            print(f'Epoch: {epoch}, Loss: {total_loss.numpy()}')

            current_image = generated_image.numpy()
